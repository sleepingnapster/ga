...
mysql_select_db($database_greenassign, $greenassign);
$query_rsAllEbooks = sprintf("SELECT lec_id, lec_filename, lec_clean, lec_verified, lec_uploadedby, lec_subid FROM lectureppts WHERE lec_classid = %s", GetSQLValueString($colname_rsAllEbooks, "text"));
