...
<i class="fa fa-angle-double-right"></i><?php echo $_SESSION['MM_Subids'][$i]['subabbv']." ".$_SESSION['MM_Subids'][$i]['subclass']; ?></a></li>
						  ...
						  <li>
							...
							<?php
								...
								if(isset($_SESSION['GA_batch_id'])){	$class_id_for_rsSubs=$_SESSION['GA_batch_id'];}
							else {echo "Error: No Batch";}
...
$query_rsSubs = sprintf("SELECT sub_id, sub_abbv 
FROM sub 
INNER JOIN activesubforbatch 
ON subforbatch_sub_id = sub_id 
WHERE subforbatch_batch_id = %s ORDER BY sub_id ASC", GetSQLValueString($class_id_for_rsSubs, "int"));
