...
$query_rsNews = "SELECT cn_id, cn_title, cn_img, cn_img0, cn_img1, cn_img2, cn_img3, cn_img4, cn_imgcount, cn_summary, cn_content, cn_by, cn_uploaddate FROM classnews WHERE cn_class_id='".$_SESSION['class_id']."' ORDER BY cn_uploadtimestamp DESC";
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-11 col-lg-9">
                        <div class="box box-solid">
                          ...
                          <?php if($row_rsNews['cn_imgcount']==1){?>
                            ...
                            <div id="carousel-example-generic<?php echo $icarl; ?>" class="carousel slide" data-ride="carousel">
                              <ol class="carousel-indicators">
                                <li data-target="#carousel-example-generic<?php echo $icarl; ?>" data-slide-to="0" class="active"></li>
                                <?php for($ii=1;$ii<$row_rsNews['cn_imgcount'];$ii++){?>
                               	<li data-target="#carousel-example-generic<?php echo $icarl; ?>" data-slide-to=<?php echo $ii; ?> class></li>
                              	<?php } ?>
                              </ol>
							  ...
							  <?php } ?>
                              <a class="left carousel-control" href="#carousel-example-generic<?php echo $icarl; ?>" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left"></span> </a> <a class="right carousel-control" href="#carousel-example-generic<?php echo $icarl; ?>" data-slide="next"> <span class="glyphicon glyphicon-chevron-right"></span> </a> </div>
                            <!-- /carousel -->
