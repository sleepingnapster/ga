...
//database entry
$tim=date("now");
  $insertSQL = sprintf("INSERT INTO classnews (cn_img,".$colstr."cn_imgcount, cn_title, cn_by, cn_by_email, cn_by_usertype, cn_uploaddate, cn_summary, cn_content, cn_class_id) VALUES ( %s,".$colval." ".$i.", %s, %s, %s, %s,CURDATE(), %s, %s, %s )",
                       ...
                       GetSQLValueString($_POST['cn_by_usertype'], "text"),
