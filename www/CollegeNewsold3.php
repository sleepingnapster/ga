...
$query_rsNews = "SELECT news_id, news_title, news_img, news_img0, news_img1, news_img2, news_img3, news_img4, news_imgcount, news_summary, news_content, news_by, news_date FROM news ORDER BY news_uploadtimestamp DESC";
