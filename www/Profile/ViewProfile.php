...
$query_RsUserDetails = sprintf("SELECT * \n"
    ...
    . ") AS Usr1\n"
    . "JOIN `user_student` \n"
    . "ON `Usr1`.`email` = `user_student`.`email`\n"
    . "JOIN `class` \n"
    . "ON `user_student`.`us_class_id` = `class`.`class_id` ", GetSQLValueString($colname_RsUserDetails, "text"));
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $row_RsUserDetails['us_displayname']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="pm-overview c-overflow" tabindex="4" style="overflow: hidden; outline: none;">
                            <div class="pmo-pic">
                                <div class="p-relative">
                                    <a href="">
                                        <img class="img-responsive" src="<?php echo rtrim($row_RsUserDetails['us_imageurl'],"50")."259"; ?>" alt=""> 
                                    </a>
                                ...
                                <div class="pmo-stat">
                                    <h2 class="m-0 c-white"><?php echo $row_RsUserDetails['us_displayname']; ?></h2>
                                </div>
                            </div>
                                ...
                                <div class="pmbb-body p-l-30">
                                    <div class="pmbb-view">
                                        <dl class="dl-horizontal">
                                            <dt>Full Name</dt>
                                            <dd><?php echo $row_RsUserDetails['us_displayname']; ?></dd>
                                        </dl>
                                         <dl class="dl-horizontal">
                                            <dt>Roll no. & Batch</dt>
                                            <dd><?php echo $row_RsUserDetails['us_rollno']; ?> - Batch <?php echo $row_RsUserDetails['us_batch'];// $_SESSION['GA_institute'] ?></dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            <dt>Class</dt>
                                            <dd><?php echo $row_RsUserDetails['class_readablename']; ?></dd>
                                        </dl>
                                         <dl class="dl-horizontal">
                                            <dt>Pid</dt>
                                            <dd><?php echo $row_RsUserDetails['us_pid']; ?></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
