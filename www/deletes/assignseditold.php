...
$query_rsAssigns = sprintf("SELECT assign_id, a_sub_id, a_class_id, a_type, a_no, a_part, a_title, a_startdate, a_subdate FROM assign WHERE a_sub_id = %s ORDER BY a_type ASC", GetSQLValueString($colname_rsAssigns, "int"));
                    ...
                    <div class="row">
                                        ...
                                        <tbody>
                                          <?php do { ?>
                                            <tr>
                                              ...
                                              <td><a href="Assignments/assignupdate.php?assignid=<?php echo $row_rsAssigns['assign_id']; ?>"><?php echo $row_rsAssigns['a_title']; ?></a></td>
						...
						<td><?php if($xxd=strtotime($row_rsAssigns['a_subdate'])){
							echo date('D d M',$xxd);}?></td>
                                              <td><a href="Assignments/assigndelete.php?assignid=<?php echo $row_rsAssigns['assign_id']; ?>&subid=<?php echo $row_rsAssigns['a_sub_id']; ?>">Delete</a>
                                            </tr>
                                            <?php } while ($row_rsAssigns = mysql_fetch_assoc($rsAssigns)); ?>
                                        </tbody>
                                    </table>
                                </div><!-- /.box-body -->
                                <a href="Assignments/assigninsert.php?subid=<?php echo $colname_rsAssigns;?>" class="btn btn-primary">Create New Assign</a>
                            </div><!-- /.box -->
                        </div>
                    </div>
