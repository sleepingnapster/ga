...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link href="../pages/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-blue">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="../pages/img/avatar3.png" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="../pages/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
        ...
        <!-- AdminLTE App -->
        <script src="../pages/js/AdminLTE/app.js" type="text/javascript"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="../pages/js/AdminLTE/demo.js" type="text/javascript"></script>
    </body>
</html>
