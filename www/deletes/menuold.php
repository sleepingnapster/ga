<?php require_once($_SERVER['DOCUMENT_ROOT'].'/OneDrive/GreenTrial/Connections/greenassign.php'); ?>
<?php
...
<ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a target="_blank" href="http://localhost/OneDrive/GreenTrial/pages/TT.php"><i class="fa fa-angle-double-right"></i> TimeTable</a></li>
                                <li><a target="_blank" href="http://localhost/OneDrive/GreenTrial/pages/Syllabus.php"><i class="fa fa-angle-double-right"></i> Syllabus</a></li>
                                <li><a href="http://localhost/OneDrive/GreenTrial/pages/resources/LecturePPTs.php"><i class="fa fa-angle-double-right"></i> Lecture PPTs</a></li>
                                <li><a href="http://localhost/OneDrive/GreenTrial/pages/resources/eBooks.php"><i class="fa fa-angle-double-right"></i> E Books</a></li>
...
for($i=0;$i<$_SESSION['MM_Subcount'];$i++) { echo   '<li><a href="http://localhost/OneDrive/GreenTrial/pages/assignsedit.php?subid='.$i.'"><i class="fa fa-angle-double-right"></i>'.$_SESSION['MM_Subids'][$i]['subabbv'].' '.$_SESSION['MM_Subids'][$i]['subclass'].'</a></li>';
                              } 
...
do { echo   '<li><a href="http://localhost/OneDrive/GreenTrial/pages/assigns.php?subid='.$row_rsSubs["sub_id"].'"><i class="fa fa-angle-double-right"></i>'.$row_rsSubs["sub_abbv"].'</a></li>';
                               
                              } while ($row_rsSubs = mysql_fetch_assoc($rsSubs));
							}else{
								echo '<li><a href="http://localhost/OneDrive/GreenTrial/pages/SelectClass.php?page=base.php"><i class="fa fa-angle-double-right"></i>Select Class</a></li>';
								}
							}
						...
						<li>
							<a href="http://localhost/OneDrive/GreenTrial/pages/Login.php">
                                <i class=""></i> <span>Login</span>
                            </a>
                        </li>
						<li>
							<a href="http://localhost/OneDrive/GreenTrial/pages/logout.php">
                                <i class=""></i> <span>Logout</span>
                            </a>
                        </li>
						<li>
							<a href="http://localhost/OneDrive/GreenTrial/pages/SelectClass.php?page=base.php">
