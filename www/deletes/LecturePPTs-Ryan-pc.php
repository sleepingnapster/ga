...
if (isset($_SESSION['class'])) {
  $colname_rsClassSubids = $_SESSION['class'];
}
else{header("Location: ../SelectClass.php?page=resources/LecturePPTs.php");exit;}
mysql_select_db($database_greenassign, $greenassign);
$query_rsClassSubids = sprintf("SELECT sub_id, sub_by_tid, sub_name, sub_abbv FROM sub WHERE sub_class = %s ORDER BY sub_id ASC", GetSQLValueString($colname_rsClassSubids, "text"));
...
if (isset($_SESSION['class'])) {
  $colname_rsAllEbooks = $_SESSION['class'];
}
mysql_select_db($database_greenassign, $greenassign);
$query_rsAllEbooks = sprintf("SELECT eb_id, eb_filename, eb_report, eb_verified, eb_uploadedby, eb_subid FROM ebooks WHERE eb_classid = %s", GetSQLValueString($colname_rsAllEbooks, "text"));
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="../UI/general.html"><i class="fa fa-angle-double-right"></i> General</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <!-- START CUSTOM TABS -->
                    <h2 class="page-header">Resources Ebooks | Lecture PPTs | Question Papers | Paper Solutions</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Custom Tabs -->
                               		  ...
                               		  <div class="box-body table-responsive">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php do { ?>
                                                            <tr>
                                                              <td><?php echo $row_rsAllEbooks['eb_id']; ?></td>
                                                              <td><?php echo $row_rsAllEbooks['eb_filename']; ?></td>
                                                              <td><?php echo $row_rsAllEbooks['eb_uploadedby']; ?></td>
                                                              <td>View</td>
                                                              <td>Download</td>
                                                        	  <td>Report</td>
                                                            </tr>
...
mysql_select_db($database_greenassign, $greenassign);
$query_rsSubidEbooks = sprintf("SELECT eb_id, eb_filename, eb_report, eb_verified, eb_uploadedby FROM ebooks WHERE eb_subid = %s ORDER BY eb_id ASC", GetSQLValueString($colname_rsSubid, "text"));
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                               <thead>
                                                ...
                                                <tbody>
                                                    <?php do { ?>
                                                            <tr>
                                                              <td><?php echo $row_rsSubidEbooks['eb_id']; ?></td>
                                                              <td><?php echo $row_rsSubidEbooks['eb_filename']; ?></td>
                                                              <td><?php echo $row_rsSubidEbooks['eb_uploadedby']; ?></td>
                                                              <td>View</td>
                                                              <td>Download</td>
                                                              <td>Report</td>
                                                            </tr>
...
<input type="hidden" name="classid" value="<?php echo $_SESSION['class']; ?>">
</p>
<p><input type="submit" class="btn btn-primary" name="upload" value="Upload File"></p>
                                    ...
                                    <div class="tab-pane" id="tab_3">
                                		...
                                		<a href="../UI/assigninsert.php" class="btn btn-primary">Upload File</a><!-- /will be reviewed first before going online -->
