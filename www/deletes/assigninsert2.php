...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO assign (a_sub_id, a_class_id, a_type, a_no, a_title, a_txt) VALUES (%s, %s, %s, %s, %s, %s)",
...
<html>
                ...
                <section class="content">
                    <form method="POST" action="<?php echo $editFormAction; ?>" name="form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="assignnumber" id="assignnumber" class="form-control" placeholder="Assign number..."/>
                           	</div>
                            <div class="form-group">
                                <label>Title</label>
                                            ...
                                            <div class="radio">
                                                <label>
                                                   ...
                                                   Assignment
                                                    ...
                                                    <input type="radio" name="assigntype" id="experiment" value="Experiment">
                                                    Experiment
                                                </label> &nbsp;&nbsp;&nbsp;<label>
    ...
    var picker = new Pikaday(
    {
        ...
        yearRange: [2014,2030],
        onSelect: function() {
            var date = document.createTextNode(this.getMoment().format('Dd MMMM YYYY') + ' ');
        }
    });
