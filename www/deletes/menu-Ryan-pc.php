...
for($i=0;$i<$_SESSION['MM_Subcount'];$i++) { echo   '<li><a href="../pages/assignsedit.php?subid='.$i.'"><i class="fa fa-angle-double-right"></i>'.$_SESSION['MM_Subids'][$i]['subabbv'].' '.$_SESSION['MM_Subids'][$i]['subclass'].'</a></li>';
                              } 
							...
							elseif(isset($_COOKIE['class'])){	$colname_rsSubs=$_COOKIE['class'];$_SESSION['class']=$_COOKIE['class'];}
							if($colname_rsSubs!=-1){
							
							
mysql_select_db($database_greenassign, $greenassign);
$query_rsSubs = sprintf("SELECT * FROM sub WHERE sub_class = %s ORDER BY sub_id ASC", GetSQLValueString($_SESSION['class'], "text"));
...
do { echo   '<li><a href="../pages/assigns.php?subid='.$row_rsSubs["sub_id"].'"><i class="fa fa-angle-double-right"></i>'.$row_rsSubs["sub_abbv"].'</a></li>';
								...
								echo '<li><a href="SelectClass.php?page=base.php"><i class="fa fa-angle-double-right"></i>Select Class</a></li>';
								}
							}
						...
						<li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="UI/general.html"><i class="fa fa-picture-o"></i> <span>Galery</span></a></li>
                                <li><a href="UI/general.html"><i class="fa fa-comments"></i> <span>Chats</span></a></li>
                                <li><a href="UI/general.html"><i class="fa fa-heart"></i> <span>Confessions</span></a></li>
                            </ul>
                        </li>
						...
						<li>
							<a href="../pages/SelectClass.php?page=base.php">
