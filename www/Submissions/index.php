                        ...
                        <div class="col-lg-3 col-sm-3">
                        	<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><small>Student List of</small></h3><h3 class="box-title"><?php echo $_SESSION['MM_Subids'][$_GET['subid']]['subabbv']." (".$_SESSION['MM_Subids'][$_GET['subid']]['subclass'].")"; ?></h3><div class="box-title">Batch :</div><div class="box-title">
