                        ...
                        <div class="col-lg-3 col-sm-3">
                        	<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><small>Student List of</small> <?php echo $_SESSION['MM_Subids'][$_GET['subid']]['subabbv']." (".$_SESSION['MM_Subids'][$_GET['subid']]['subclass'].")"; ?></h3><div class="box-title">Batch :
