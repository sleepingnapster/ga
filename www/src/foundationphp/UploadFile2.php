...
class UploadFile
{
	...
	protected $fileNameToDb = array();
	protected $finalName;
	protected $maxSize = 1048576;//31457280>30mb
	...
	{
		if(isset($this->finalName)){return $this->finalName;}
	}
	public function getfileNameToDb()
	{
		if(isset($this->fileNameToDb)){return $this->fileNameToDb;}
	}
