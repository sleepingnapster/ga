...
//database entry
  $insertSQL = sprintf("INSERT INTO ebooks (eb_filename, eb_uploadedby, eb_sub_id) VALUES (%s, %s, %s)",
...
else{header ("Location:  ?success=0&subid=".$_POST['subid']."&feedback=".$feedback);}
