...
<label for="filename">Upload File:</label>
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" name="news_title" class="form-control" placeholder="Enter ..." required>
                                    </div>
                                    <div class="form-group">
                                        <label>Summary</label>
                                        <input type="text" name="news_summary" class="form-control" placeholder="Enter ..."/>
                                    </div>
                                    <div class="form-group">
                                        <label>Content</label>
    ...
    <li>Image width 900px or higher. <?php //echo $_SESSION ['displaymax'];?></li>
</ul></p>
                                	</div>
                                    
                                </div>
                                <div class="box-footer">
                                <input type="text" name="news_collegeid" value="sfit" hidden>
                    <input type="text" name="news_class" value="<?php if(isset($_SESSION['class'])){echo $_SESSION['class'];}else{
					 header(sprintf("Location: ../pages/SelectClass.php?../ClassNews/"));}  ?>" hidden>
                     
                    <input type="text" name="news_by" value="<?php if(isset($_SESSION['GA_name'])){echo $_SESSION['GA_name'];}else{
					 header(sprintf("Location: ../index.php"));}  ?>" hidden>
                     
                     <input type="text" name="news_email" value="<?php if(isset($_SESSION['email'])){echo $_SESSION['email'];}else{
					 header(sprintf("Location: ../index.php"));}  ?>" hidden>
